...
public class JsonMapper extends ObjectMapper {
    ...
    public static <T> T fromJson(String src, Type type) {
        ...
        try {
            ...
            logger.warn("update json string:" + src + " to object:" + type + " error.", var4);
            return null;
        }
    }
    ...
    public static <T> T fromJson(byte[] src, Type type) {
        ...
        try {
            ...
            logger.warn("update json byte:" + src + " to object:" + type + " error.", var4);
            return null;
        }
    }

    public static <T> T convertVal(Object src, Class<T> dest) {
        return getInstance().convertValue(src, dest);
    }
